...
const ContactSection = () => {
  ...
  return (
    <Section>
      <h2 className="text-5xl font-bold mt-6">Contact me</h2>
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex items-center gap-3 mt-4">
                {socialLinks.map((link) => (
                  <a href={link.path} key={link.path} className="w-9 h-9 border border-solid border-[#181A1E] rounded-full flex items-center justify-center group hover:bg-primaryColor hover:border-none">
                    {link.icon}
                  </a>
                ))}
              </div>
